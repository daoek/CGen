...
final class AdapterRenderer {
    ...
    private static void appendHeaderTop(StringBuilder out, AdapterSpec adapter, InterfaceSpec from, InterfaceSpec to,
        ...
        out.append(PinfitTag.generatedFile("adapter-header", adapter.source().getFileName().toString())).append('\n');
    ...
    private static void appendHeaderContextStruct(StringBuilder out, ProjectConfig project, AdapterSpec adapter, InterfaceSpec to) {
        out.append(PinfitTag.generatedItem("context", adapter.name())).append('\n');
    ...
    private static void appendSetTargetDeclaration(StringBuilder out, ProjectConfig project, AdapterSpec adapter, InterfaceSpec to) {
        ...
        out.append(PinfitTag.generatedItem("function", setTarget)).append('\n');
    ...
    private static void appendSourceTop(StringBuilder out, AdapterSpec adapter, DocumentationRenderer docs, UserRegions user) {
        out.append(PinfitTag.generatedFile("adapter-source", adapter.source().getFileName().toString())).append('\n');
