...
class YamlErgonomicsTest {
    ...
    void distinctiveUsercodeMarkersReplaceOldFormat() throws Exception {
        ...
        assertTrue(header.contains("/*@Pinfit usercode+ interface.preamble*/"));
        assertTrue(header.contains("/*@Pinfit usercode-*/"));
        assertTrue(!header.contains("@Pinfit(+"));
        assertTrue(!header.contains("@Pinfit(-"));
    }
