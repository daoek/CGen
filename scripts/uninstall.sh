#!/usr/bin/env sh
#
# Removes a CGen installation made by install.sh. Refuses unless the install directory carries
...
INSTALL_DIR="${1:-${CGEN_INSTALL_DIR:-$SELF_DIR}}"
MARKER_PATH="$INSTALL_DIR/.cgen-install-marker"
...
rm -rf "$INSTALL_DIR"
echo "CGen uninstalled from $INSTALL_DIR."
